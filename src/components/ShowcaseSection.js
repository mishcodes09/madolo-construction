        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:h-[500px]">
          ...
          <div className="order-1 lg:order-2 flex flex-col justify-center px-6 md:px-10 lg:px-16 py-10 lg:py-12">
            ...
            <p className="font-body text-white/80 text-base leading-relaxed mb-6 max-w-md">
              Explore our portfolio of residential, commercial, and community
              projects — each crafted with detail, discipline, and design
              intent.
            </p>
            ...
            <a
              href="/projects"
              className="inline-flex items-center gap-2 bg-white text-[#eb191a] font-body font-semibold text-sm px-7 py-3 hover:bg-white/90 transition-colors duration-300 self-start"
            >
              View Projects
            </a>
          </div>
